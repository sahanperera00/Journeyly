...
function Packages() { 
  ...
  return (
    ...
    <h1 className='packageHeader'>Packages
          <h2 className='PackageDiscription'>Enjoy WonderFul Experience in Sri Lanka<br/>
                             Let us Help You Prepare <br/>Plan Your Trip With Us </h2></h1>
    <div className='container d-flex flex-wrap' style={{ width: '80%'}}>
      {packages.map((data) => {
        return (
          <Card style={{ width: '25rem', margin: '2rem', padding: '0rem'}} className='PackageCard'>
