        ...
        <div className='DestinationUpdateFormMainCont'>
            ...
            <div className="DestinationUpdateFormCont">
                <form onSubmit={async (e) => {
                    ...
                    await axios.put("http://localhost:8070/destination/update/" + id, newDestination).then(() => {
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" value={name} onChange={(e) => { setName(e.target.value) }} readOnly/>
                    </div>
                    <div className="form-group">
                        <label className="form-label">Child Ticket Buying Rate</label>
                        <input type="text" className="form-control" onChange={(e) => { setChildTicketBuyingRate(e.target.value) }} required/>
                    </div>
                    <div className="form-group">
                        <label className="form-label">Child Ticket Selling Rate</label>
                        <input type="text" className="form-control" onChange={(e) => { setChildTicketSellingRate(e.target.value) }} required/>
                    </div>
                    <div className="form-group">
                        <label className="form-label">Adult Ticket Buying Rate</label>
                        <input type="text" className="form-control" onChange={(e) => { setAdultTicketBuyingRate(e.target.value) }} required/>
                    </div>
                    <div className="form-group">
